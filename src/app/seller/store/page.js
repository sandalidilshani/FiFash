      ...
      <div className="py-8 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-48">
        <div className="flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
            <div
              className="w-full max-w-xs mx-auto bg-brown text-white font-bold shadow-lg rounded-lg overflow-hidden cursor-pointer p-6 md:p-8 m-4 text-center transition-transform transform hover:scale-105"
              onClick={openAddProductModal}
            >
              <span className="text-lg md:text-xl">+ Add Product</span>
            </div>
